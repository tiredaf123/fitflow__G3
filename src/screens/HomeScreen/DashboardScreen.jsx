...
const DashboardScreen = () => {
    ...
    const themeStyles = {
        ...
        navbar: { backgroundColor: isDarkMode ? '#2A2A2A' : '#FFF', borderColor: isDarkMode ? '#444' : '#DDD', paddingVertical: 15, marginBottom: 10 },
        section: { backgroundColor: isDarkMode ? '#2A2A2A' : '#FFF', borderColor: isDarkMode ? '#444' : '#DDD', padding: 20, borderRadius: 16, marginBottom: 20 },
        text: { color: isDarkMode ? '#FFF' : '#000' },
        iconColor: isDarkMode ? '#00BFFF' : '#FF6B00',
        cardBackground: isDarkMode ? '#333' : '#E0E0E0',
        navbarIcon: { marginLeft: 10, marginRight: 10 },
    ...
    return (
        <View style={themeStyles.container}>
            <ScrollView style={{ padding: 20 }}>
                ...
                {/* Top Navigation Bar */}
                <View style={[{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, themeStyles.navbar]}>
                    <Icon name="bars" size={20} color={themeStyles.text.color} style={themeStyles.navbarIcon} />
                ...
                {[
                    ...
                    >
                        ...
                        <View style={{ flex: 1, marginLeft: 10 }}>
                            ...
                            {item.subtext && <Text style={[{ fontSize: 12, marginTop: 2 }, themeStyles.text]}>{item.subtext}</Text>}
                        </View>
